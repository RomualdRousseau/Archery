...
public class IntelliTableStrategyWithPivotType extends IntelliTableStrategy {
    ...
    protected void emitHeaders(final BaseTable table, final BaseHeader header, final Set<String> pivotEntryTypes) {
        ...
        this.addHeaderIntoTmpHeaders(table, pivotHeader, false);
        this.addHeaderIntoTmpHeaders(table, pivotHeader.getPivotTypeHeader().clone(), false);
        this.addHeaderIntoTmpHeaders(table, pivotHeader.getPivotValueHeader().clone(), false);
    }
