...
public class AppTest extends TestCase
{
            ...
            for(String expectedValue: expectedValues) {
                switch(state) {
                    case 0:
                        ...
                        table = sheet.getTable();
                        assert table != null;
                        table.updateTags(tagClassifier, 10);
                        state = 1;
                        break;
                    case 1:
    ...
    private IDocument loadDocument(String resourceName, String encoding) {
        try {
            ...
            return DocumentFactory.createInstance(Paths.get(resourceUrl.toURI()).toString(), encoding, 30, 10);
        }
        catch(Exception x) {
    ...
    private Dictionary loadDictionary(String resourceName) {
        try {
            ...
            dic.loadFromFile(Paths.get(resourceUrl.toURI()).toString());
            return dic;
        }
        catch(Exception x) {
            assert false : x.getMessage();
    ...
    private String[][] scenarios1 = {
        {"/data/강원동양.xls", "한국세르비에", "22", "매출처", "강릉아산병원", "매출일", "2016/06/01", "품명", "디아미크롱서방정", "규격", "30mg/500T", "수량", "1", "대표자", "하현권", "주소", "강원도 강릉시 방동길 38   (사천면)", "비고", ""},
        {"/data/강원백제.xls", "강원백제", "352", "메이커명", "한국세르비에", "약국명", "약국", "사업자번호", "2240346108", "제품명", "디아미크롱서방정30mg 500T", "출하수량", "1", "단가", "59000", "출하금액", "59000", "주소", "강원도 원주시 중앙로 86, 1동 102호 (중앙동)", "우편번호", "220-010", "날짜", "2016-06-02", "표준코드", "8806763000422"},
        {"/data/강원서호.xls", "work", "56", "매출처", "강릉약국(신)", "제품명", "헤파멜즈산", "재고", "74", "규격", "5g/100포", "현보험가", "57,000.00", "수량", "8", "매출단가", "57,000.00", "매출금액", "456,000", "주소", "강원도 강릉시 방동길", "우편번호", "25440"},
        {"/data/강원순천당.xls", "work", "101", "매출처", "강릉시민약국", "제품명", "디아미크롱정 100T(PTP)", "재고", "13", "규격", "100T", "현보험가", "11,900.00", "수량", "1", "매출단가", "11,900.00", "매출금액", "11,900", "사업자등록번호", "226-01-84424", "주소", "강원도 강릉시 경강로 2109   (임당동)", "대표자", "최종정외 2명", "거래처종류", "약국", "우편번호", "25532", "전화번호", "642-8255", "판매일자", "2016/06/07", "표준코드", "8806447031711"},
        {"/data/광주순천호남.XLS", "광주순천호남", "218", "거래처코드", "21216", "상호", "고흥)고흥병원", "장부일자", "2016/06/01", "품명", "아서틸정4mg", "포장", "90T", "수량", "2", "매출단가", "43,920", "매출금액", "87,840", "유형", "일반매출", "사업자번호", "413-82-01929", "대표자", "류형식", "우편번호", "59535", "신우편번호", "59535", "주소", "전라남도 고흥군 고흥읍고흥로, 1935 (남계리,숙소) 남계 186번지", "주소", "전라남도 고흥군 고흥읍고흥로, 1935", "약가코드", "676300060", "담당자", "김정호", "부서명", "90.영업3팀", "제조원", "한국세르비에", "대표코드", "8806763000606", "표준코드", "8806763000613", "판매분류", "01.정상품", "기타분류", ""},
        {"/data/대구경일.xls", "매출현황", "24", "년월", "201611", "매입처", "세르비에", "제약사", "세르비에", "상품명", "프로코라란정5mg", "규격", "56T(P)", "수량", "-1", "상대처", "안동성소", "주소", "경상북도안동시서동문로"},
        {"/data/대구지오팜.xls", "한화제약_201612_보험", "2076", "제품명", "그로리정97.875mg(병)", "규격", "30T", "보험코드", "651601730", "수량", "1", "매출일자", "12/2/16", "거래처분류", "약국", "우편번호", "719-801", "주소", "경북 성주군 성주읍"},
        {"/data/대전경동팜.xlsx", "Sheet1", "161", "일자", "2016/12/05", "제품명", "디아미크롱서방", "규격", "30/500T", "매출처", "수원123약국", "수량", "2", "현보험약가", "59,000.00", "보험금액", "118,000", "우편번호", "16501", "주소", "경기도 수원시 영통구 월드컵로", "표준코드", "8806763000422"},
        {"/data/대전엘에스팜.xls", "Sheet1", "36", "순번", "1", "도매등록번호", "3038130270", "거래일자", "20170623", "제품코드", "8806763000422", "코드유형", "표준코드", "제조원", "한국세르비에(주)", "품명", "디아미크롱서방정30mg", "규격", "500T", "평균판매가", "59,000.00", "수량", "3", "매출액", "177,000", "우편번호", "31151", "주소", "충청남도 천안시 동남구 순천향4길, 50", "주소1", "충청남도 천안시 동남구", "출고처등록번호", "7811500011", "출고처", "천안)순천당약국(신)", "거래처구분", "약국", "입력일시", "20170623134726", "보험구분", "전문/보험", "요양기관기호", "34832122", "담당자", "이동준", "보험코드", "676300040", "업무구분", "1.통합"},
        ...
        {"/data/전주전주.xls", "work", "108", "입고처", "에스케이케미칼", "발주처", "한국세르비에", "매출처", "김제건강종합약국", "원재고거래처", "재고적용거래처", "적용재고거래처", "재고적용거래처", "제품코드", "01760", "제품명", "디아미크롱정80mg(P)", "재고", "17", "규격", "100T", "현보험가", "11,900.00" ,"수량", "-1", "매출단가", "11,900.00", "매출금액", "-11,900", "사업자등록번호", "405-02-91694", "주소", "전라북도 김제시 남북로 222   (요촌동)", "대표자", "박동현", "거래처종류", "약국", "우편번호", "54384", "전화번호", "547-2073", "제조사", "에스케이케미칼", "판매일자", "2016/10/07", "거래처코드", "50338", "KD코드", "644703170", "담당자명", "우창걸", "요양기관코드", "35805366", "단가적용처", "단가적용거래처", "거래처그룹", "일반", "시점별보험가", "11,900.00", "표준코드", "8806447031711", "매출금액", "-11,900"}
    };
