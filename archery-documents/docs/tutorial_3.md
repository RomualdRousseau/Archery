...
and creates headaches when loading data. We will see that Archery automatically removes those artifacts (method called
...
Archery has a very modular design where each functionality can be loaded separatly. We add the "archery-layex-parser"
